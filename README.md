**Your Project's Name**
Saturday. [An ecommerce platform, selling different type of women shoes.]
...
I will only do for the page that i have done for now which is index page for now, the rest not confirmed about the functionality. 

For index page, I have a navigation bar that will become transparent when you scroll all the way to the top and when scrolling down to the contents it will become white and stick to the top. Secondly, it will also have a slideshow of 10 seconds, also with a next carrot button for users if they would want to manually get 
...
The Language i use is HTML, CSS and JavaScript. 
...
**Testing -> will do when done with my website**
...
<!-- Content: -> not yet for the moment.  -->
<!-- The text for section Y was copied from the Wikipedia article Z -->

**Media:**
Video for index page ->
https://www.pexels.com/video/salesperson-putting-a-bag-inside-a-paper-bag-9595334/

Others -> some i edit myself 
https://www.canva.com/
...
Acknowledgements:
I received inspiration for this project from Sunday.staples which is a shoe store like what i am trying to do but 
